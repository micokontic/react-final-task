  ...
  return (
    <div className="detail-product-container">
      <div className="detail-product-image">
        ...
        <div
          className="map-container-with-map"
      ...
      <div className="detail-product-data">
        ...
        <div className="detail-product-location botton-border">
          <div>
            <div className="location-continer" id="location-container">
        ...
        <div className="detail-product-data-rating botton-border">
          ...
          <div className="review">
            <a>1 Bonfire Review(s)</a> <span class="separator">|</span>{" "}
            <a>Add Your Bonfire Review</a>
          </div>
        </div>
        ...
        <div className="detail-product-overview botton-border">
          ...
          <p>
            It is the deepest canyon in Europe, and second deepest in the world
            after the Grand Canyon of Colorado, USA. 78km long, and up to 1.300m
            deep, this "tear of Europe", as it is also called, is a great
            natural and tourist attraction not only in the area, but in the
            entire country.
          </p>
          <div className="details">
            <div class="details-row">
              ...
              <h5>
                Duration: <p>{activitie.duration}</p>
              </h5>
            </div>
            <div class="details-row">
              <img src={FitnessLogo}></img>
              <h5>
                Fitness level: <p>{activitie.fitnessLevel}</p>
              </h5>
            </div>
            <div class="details-row">
              <img src={KidLogo}></img>
              <h5>
                Allowed for kids? <p>{activitie.goodForKids}</p>
              </h5>
            </div>
            <div class="details-row">
              <img src={GroupLogo}></img>
              <h5>
                Group tours possible? <p>{activitie.groupTours}</p>
              </h5>
            </div>
            <div class="details-row">
              <img src={NumberLogo}></img>
              <h5>
                Maximal group size: <p>{activitie.maximalGroupSize}</p>
              </h5>
            </div>
          </div>
        </div>
