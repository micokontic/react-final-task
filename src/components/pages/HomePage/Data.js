export const activities = {
  ...
  shortDesc:
    "Recently, windsurfing is increasingly catching the fancy of all and hence the demand for windsurfing lesson is rapidly increasing...",
  imgStart: "start",
  date: "February 22",
...
export const atractions = {
  ...
  shortDesc:
    "Windsurfing About Content Windsurfing as an adventurous sport and recreational pastime first peaked in 1980s only to fall...",
  imgStart: "",
  date: "February 21",
...
export const dayTrips = {
  ...
  shortDesc:
    "Finally, he returned home and started his own academy in Dominic Republic as he wishes to nurture all local talent ... ",
  imgStart: "start",
  date: "February 21",
...
export const guides = {
  ...
  shortDesc:
    "About One Windsurfer Tim Bennet is the esteemed founder as well as a leading instructor at Adrenaline. He has over 20 years of rich experience",
  imgStart: "",
  date: "February 18",
